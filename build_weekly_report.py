...
def main():
    ...
    <tr><td><b>8/15（明/後天）</b></td><td>國泰 1,200萬 撥款 → 兩層槓桿版</td><td>⏳ 待執行</td></tr>
    <tr><td>8/15 起</td><td>還債 800萬（4%+ 高息優先）→ 負債 1,015萬</td><td>⏳</td></tr>
    <tr><td>8/15-9月</td><td>分批換匯建美元直債梯（3-7Y 375 + 8-10Y 125）</td><td>⏳</td></tr>
...
<li><b>兩層槓桿版</b>：階段1 強制還債建倉；階段2 質押是加分題非必做（4 門檻全過才開）</li>
