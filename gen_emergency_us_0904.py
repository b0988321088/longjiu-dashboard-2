# -*- coding: utf-8 -*-
"""美股緊急應變 9/4 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-09-04.html (Railway 版) + emergency_taiex_report_2026-09-04.html (GitHub 版)
...
{pen_html}
{sec_html}
<div class="foot">龍九控股內部報告｜僅供決策參考，非投資建議｜資料時間 {NOW} 台北（美股開盤）｜Yahoo Finance chart API 即時 + Yahoo RSS + us30y_state + snapshot.json 穿透數據</div>
</div></body></html>"""
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "53,540.88", "-0.27%", "down"), ("S&P 500", "7,740.78", "-0.09%", "down"),
        ("納斯達克 (IXIC)", "26,606.22", "+0.08%", "up"), ("費城半導體 (SOX)", "11,592.08", "+2.11%", "up"),
        ("台積電 ADR (TSM)", "422.90", "+1.41%", "up"), ("NVIDIA (NVDA)", "233.09", "+2.03%", "up"),
        ("Apple (AAPL)", "325.77", "-0.74%", "down"), ("Microsoft (MSFT)", "506.10", "-0.79%", "down"),
        ("Meta (META)", "608.25", "-0.40%", "down"), ("Amazon (AMZN)", "258.45", "-0.17%", "down"),
        ("Alphabet (GOOGL)", "341.73", "-0.22%", "down"), ("VIX 恐慌指數", "14.07", "-1.75%（低檔）", "up"),
        ("US30Y", "5.27%", "警戒5.30·防禦", "warn"), ("台股加權 (TWII)", "46,551.13", "日收+1.51%（夜盤-300）", "up"),
    ]
