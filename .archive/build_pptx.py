...
info_card(s,0.5,1,9,2.5,["國泰轉貸撥款（9 月底）","├── 清償永豐房貸 1,316 萬（9/25 到期）","├── 清償保單借貸 400 萬（利率 ~5%→0%）","│     ├─ 安聯A 200 萬 │ ├─ 安聯B 100 萬","│     └─ 第一金FA81聯博 100 萬","└── 剩餘資金 ~300 萬（低利 2.185% 可用於投資）"],sz=12,title="",tc=TXT)
