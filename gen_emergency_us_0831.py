# -*- coding: utf-8 -*-
"""美股緊急應變 8/31 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-31.html (Railway 版) + emergency_taiex_report_2026-08-31.html (GitHub 版)
...
{pen_html}
{sec_html}
<div class="foot">龍九控股內部報告｜僅供決策參考，非投資建議｜資料時間 {NOW} 台北（美股開盤）｜Yahoo Finance chart API 即時 + daily_analysis briefing + us30y_state + snapshot.json 穿透數據</div>
</div></body></html>"""
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "53,248.46", "-0.58%", "down"), ("S&P 500", "7,683.10", "-0.37%", "down"),
        ("納斯達克 (IXIC)", "26,334.44", "-0.26%", "down"), ("費城半導體 (SOX)", "11,559.45", "+0.78%", "up"),
        ("台積電 ADR (TSM)", "421.28", "-1.22%", "down"), ("NVIDIA (NVDA)", "217.46", "-4.07%", "down"),
        ("Apple (AAPL)", "318.50", "+0.50%", "up"), ("Microsoft (MSFT)", "509.55", "+0.31%", "up"),
        ("US30Y", "5.19%", "防禦5.20", "warn"), ("台股加權 (TWII)", "46,128.47", "-0.44%", "down"),
    ]
