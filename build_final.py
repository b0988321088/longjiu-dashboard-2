...
B(s, [
    f'🔴 保單借貸 {pl/10000:,.0f} 萬 @4%+ → 9/11 質押簽約後 350 萬@2.8% 償還',
    '     （還安聯 300 萬 + 元大 50 萬），利息成本 4%+ → 2.8%',
    '',
...
B(s, [
    '📅 9/11(五)13:00：板橋國泰質押簽約 → 350 萬@2.8% 還安聯 300 + 元大 50（撥款 2-4 週）',
    '',
...
B(s, [
    '1️⃣ 【您】9/11(五)13:00 板橋國泰質押簽約 → 350 萬@2.8%（帶身分證+印鑑）',
    '      還安聯 300 萬 + 元大 50 萬 → 保單借貸成本 4%+ 降至 2.8%',
    '',
...
B(s, [
    ...
    '',
    '🏠 債務 ~2.6%：比市場低 4pp+，9/11 質押 350 萬@2.8% 再降成本',
    '',
