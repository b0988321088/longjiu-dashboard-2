# -*- coding: utf-8 -*-
"""美股緊急應變 8/12 21:31 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-12.html (Railway 版) + emergency_taiex_report_2026-08-12.html (GitHub 版)
"""
...
{kpis_html}
{sec_html}
<div class="foot">龍九控股內部報告｜僅供決策參考，非投資建議｜資料時間 {NOW} 台北（美股開盤）｜Yahoo Finance chart API 即時 + Yahoo RSS + daily_analysis briefing + snapshot.json 穿透數據</div>
</div></body></html>"""
...
def build():
    ...
    kpis = [
        ("道瓊", "53,824.49", "+0.06%", "up"), ("S&P 500", "7,751.40", "+0.30%", "up"),
        ("納斯達克", "26,602.36", "+0.59%", "up"), ("費城半導體", "12,499.29", "+3.31%", "up"),
        ("台積電 ADR", "430.05", "+1.89%", "up"), ("NVDA", "221.58", "+1.88%", "up"),
        ("VIX", "14.96", "-2.09%", "down"), ("US30Y", "5.25%", "防禦5.20", "warn"),
        ("WTI", "82.85", "-0.42%", "down"), ("黃金", "4,477.10", "+2.15%", "up"),
    ]
