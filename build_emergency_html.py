...
<li><b>現金紀律：</b>現金 18.4% &gt; 14.5% 目標，惟高於 現金底線 70 萬之緩衝充足，緩衝充足；若防守補碼使現金降至 15% 以下即停止補碼。</li>
...
<li>✅ 安全網（債券+現金）合計 35.4%，緩衝充足；現金為底線 70 萬之緩衝充足，runway 27.1 個月。</li>
<li>美股 +2.3pp、債券 +4.0pp、現金 +3.9pp 超標 → 以「配息導流 + 暫緩新增」自然收斂，不主動砍倉。</li>
</ul></div>

<div class="card"><h2>五、巴菲特/蒙格式建議 <span class="tag">臨時階段規則：00878續建4週｜00983D暫緩｜單筆≥5萬暫停｜現金底線70萬</span></h2>{sec5}</div>
