...
## 產出流程
1. 讀取 C:/Users/bot/Desktop/longjiu_system/Company_Ledger.md 取得資產負債最新數據
2. 讀取 C:/Users/bot/Desktop/longjiu_system/framework_snapshot_2026-07-16.json 取得系統快照
3. 讀取 C:/Users/bot/Desktop/longjiu_system/moneybook_6m_analysis.py 錯誤
4. 寫入 daily_report_v2_YYYY-MM-DD.md 檔案

## 大腦成熟度指標（新增）
在日報末尾加入「MEMORY_HEALTH」區段：
- 執行 python C:/Users/bot/Desktop/longjiu_system/holographic_daily_check.py
...
result = subprocess.run([
    ...
    '--job-id', 'ebe15ce7517f',
    '--prompt', prompt,
    '--workdir', 'C:\\Users\\bot\\Desktop\\longjiu_system'
