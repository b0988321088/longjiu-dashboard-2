...
<tr><td>① 債務優化（高息清零）</td><td>現在 ~ 2027/2</td><td>PI 質押 350萬@2.8% 還安聯300@4.2%+元大50@3.92%（年省 ~5萬）；洲際W轉貸 ≤2.5%；築巢 2.185% 生效 → 負債成本逐階下探</td></tr>
...
<ul>
<li>① 債務優化（高息清零）— 執行中（PI 質押 350萬@2.8%（9/11 簽約）還安聯/元大）</li>
