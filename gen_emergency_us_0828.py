# -*- coding: utf-8 -*-
"""美股緊急應變 8/28 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-28.html (Railway 版) + emergency_taiex_report_2026-08-28.html (GitHub 版)
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "53,722.34", "+0.29%", "up"), ("S&P 500", "7,736.59", "+0.07%", "up"),
        ("納斯達克 (IXIC)", "26,509.01", "-0.12%", "down"), ("費城半導體 (SOX)", "11,705.02", "-1.49%", "down"),
        ("台積電 ADR (TSM)", "426.48", "-0.19%", "down"), ("NVDA", "226.69", "-0.57%", "down"),
        ("AAPL", "316.93", "+0.75%", "up"), ("MSFT", "507.96", "+0.57%", "up"),
        ("US30Y", "5.18%", "防禦5.20", "warn"), ("台股加權 (TWII)", "46,331.45", "+0.77%", "up"),
    ]
