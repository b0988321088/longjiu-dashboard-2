# -*- coding: utf-8 -*-
"""美股緊急應變 8/14 21:31 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-14.html (Railway 版) + emergency_taiex_report_2026-08-14.html (GitHub 版)
"""
...
def build():
    ...
    kpis = [
        ("道瓊", "53,807.44", "-0.06%", "down"), ("S&P 500", "7,802.73", "+0.05%", "up"),
        ("納斯達克", "26,844.66", "+0.16%", "up"), ("費城半導體", "12,409.12", "-0.38%", "down"),
        ("台積電 ADR", "426.26", "-0.98%", "down"), ("NVDA", "226.82", "+0.67%", "up"),
        ("VIX", "14.49", "-0.96%", "down"), ("US30Y", "5.24%", "防禦5.20", "warn"),
        ("台股加權", "46,053.81", "+0.07%", "up"), ("台積電", "2,415.00", "-0.82%", "down"),
    ]
