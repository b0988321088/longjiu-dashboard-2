# -*- coding: utf-8 -*-
"""美股緊急應變 8/13 21:31 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-13.html (Railway 版) + emergency_taiex_report_2026-08-13.html (GitHub 版)
"""
...
{kpis_html}
{sec_html}
<div class="foot">龍九控股內部報告｜僅供決策參考，非投資建議｜資料時間 {NOW} 台北（美股開盤）｜Yahoo Finance chart API 即時 + daily_analysis briefing + FRED DGS30 + snapshot.json 穿透數據</div>
</div></body></html>"""
...
def build():
    ...
    kpis = [
        ("道瓊", "53,892.95", "+0.23%", "up"), ("S&P 500", "7,771.82", "+0.30%", "up"),
        ("納斯達克", "26,649.79", "+0.23%", "up"), ("費城半導體", "12,426.84", "+0.22%", "up"),
        ("台積電 ADR", "429.27", "+0.03%", "up"), ("NVDA", "226.77", "+1.20%", "up"),
        ("VIX", "14.42", "-0.89%", "down"), ("US30Y", "5.24%", "防禦5.20", "warn"),
        ("台股加權", "46,021.48", "+1.11%", "up"), ("台積電", "2,435.00", "+0.83%", "up"),
    ]
