# -*- coding: utf-8 -*-
"""美股緊急應變 9/1 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "52,905.46", "-0.53%", "down"), ("S&P 500", "7,634.60", "-0.67%", "down"),
        ("納斯達克 (IXIC)", "26,009.22", "-1.37%", "down"), ("費城半導體 (SOX)", "11,277.48", "-2.23%", "down"),
        ("台積電 ADR (TSM)", "415.14", "-0.04%", "down"), ("NVIDIA (NVDA)", "215.41", "-2.43%", "down"),
        ("Apple (AAPL)", "315.62", "-0.39%", "down"), ("Microsoft (MSFT)", "499.35", "-1.57%", "down"),
        ("US30Y", "5.22%", "警戒5.20", "warn"), ("台股加權 (TWII)", "46,908.02", "+1.69%", "up"),
    ]
