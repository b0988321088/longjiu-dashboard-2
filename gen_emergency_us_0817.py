...
{kpis_html}
{sec_html}
<div class="foot">龍九控股內部報告｜僅供決策參考，非投資建議｜資料時間 {NOW} 台北（美股開盤）｜Yahoo Finance chart API 即時 + finance.yahoo.com RSS + daily_analysis briefing + us30y_state/FRED DGS30 + snapshot.json 穿透數據</div>
</div></body></html>"""
...
def build():
    ...
    kpis = [
        ("道瓊 (DIA)", "534.87", "-0.36%", "down"), ("S&P 500 (SPY)", "775.84", "-0.06%", "down"),
        ("納斯達克 (QQQ)", "733.35", "+0.31%", "up"), ("費城半導體 (SOXX)", "558.63", "+1.49%", "up"),
        ("台積電 ADR", "427.95", "+0.38%", "up"), ("NVDA", "225.60", "+0.20%", "up"),
        ("MSFT", "490.14", "-1.06%", "down"), ("META", "579.65", "-1.73%", "down"),
        ("US30Y", "5.21%", "防禦5.20", "warn"), ("台股加權", "46,027.70", "+0.47%", "up"),
    ]
