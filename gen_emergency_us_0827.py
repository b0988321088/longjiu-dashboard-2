# -*- coding: utf-8 -*-
"""美股緊急應變 8/27 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
產出：emergency_report_2026-08-27.html (Railway 版) + emergency_taiex_report_2026-08-27.html (GitHub 版)
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "53,363.17", "-0.19%", "down"), ("S&P 500", "7,692.63", "+0.22%", "up"),
        ("納斯達克 (IXIC)", "26,308.60", "+0.68%", "up"), ("費城半導體 (SOX)", "11,875.69", "+2.28%", "up"),
        ("台積電 ADR (TSM)", "423.21", "+1.32%", "up"), ("NVDA", "223.33", "+6.52%", "up"),
        ("AAPL", "310.60", "-0.91%", "down"), ("MSFT", "491.93", "-0.89%", "down"),
        ("US30Y", "5.17%", "防禦5.20", "warn"), ("台股加權 (TWII)", "45,975.22", "+0.31%", "up"),
    ]
