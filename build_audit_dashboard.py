...
EXP = s.get("monthly_expense", 141958); FIXED = 253026
...
<div style="font-size:11px;color:#94a3b8;margin-top:6px">美元曝險 <b style="color:#ef4444">{usd_exp}%</b>（紅線 50%）→ 選台幣計價避險標的不推高；MMF 轉配置優先累積型</div>
</div></div>
