#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""memory_ops.py — 記憶維運單一入口（整合 3 支：memory_backup/run_memory_archiver/memory_sync）。

  backup  備份＋歸檔檢查（06:45）
  sync    跨代理記憶同步（19:00 離峰）"""
import argparse
import os
import subprocess
import sys
...
DEFAULT_MODE = 'sync'
MODES = {'backup': [('run_memory_archiver.py', (), False), ('memory_backup.py', (), False)], 'sync': [('memory_sync.py', (), False)]}
