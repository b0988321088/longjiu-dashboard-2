# -*- coding: utf-8 -*-
"""台股緊急應變 2026-08-15 — LLM 分析 → data/emergency_llm_analysis.json + emergency_report_2026-08-15.html"""
import json, datetime, re
from pathlib import Path

BASE = Path(__file__).resolve().parent
TODAY = "2026-08-15"
GEN_AT = "2026-08-15 13:16"
...
【四、資產配置透視】
資料：snapshot.json penetration.actual_twd（2026-08-15）｜臨時階段目標：美股 30 / 台股 23.5 / 防守 19 / 債券 13 / 現金 14.5。
...
def _refresh_penetration(report_text: str) -> str:
    ...
    try:
        ...
        import re as _re
        # INC-134 修正（2026-08-15）：匹配實際格式「台股市值型成長 1,556,969 TWD：...」
