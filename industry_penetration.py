...
_FUND_IND = {
    ...
    # 股債平衡（股債拆解後股票部分再分產業）
    "富達全球動能多元": {
        "資訊科技": 0.2179, "金融": 0.126, "原物料": 0.087, "通訊服務": 0.0677, "工業": 0.0668, "醫療保健": 0.0731, "非核心消費": 0.0677, "核心消費": 0.0381, "能源": 0.0323, "公用事業": 0.0185, "不動產": 0.0124, "其他": 0.0246, "固收/現金": 0.1678,
        "_src": "L1+L3 官方資產類別2026/07/31（股73.04/企業債8.77/股權類衍生7.72/新興市場債4.21/另類資產2.46/現金及其他2.17/固收衍生0.88/公債0.75，MoneyDJ fth29）；5 行業＝晨星2025/12 官方（科技21.79/金融12.6/原物料8.7/電信6.77/工業6.68）；未揭露權益尾（含股權衍生）依 MSCI World 相對權重補；另類資產（黃金/商品）留其他",
    },
    "聯博全球多元收益": {
        "資訊科技": 0.1196, "金融": 0.0621, "工業": 0.0417, "醫療保健": 0.0352, "非核心消費": 0.0325, "通訊服務": 0.0325, "核心消費": 0.0183, "能源": 0.0155, "原物料": 0.0125, "公用事業": 0.0089, "不動產": 0.0059, "其他": 0.0012, "固收/現金": 0.614,
        "_src": "L3 官方資產類別2026/07/31（MoneyDJ albg6）：環球信用債41.48/環球主權債19.93/高股息股票18.80/全球股票11.10/新興市場股票4.73/股票選擇權策略3.96 → 權益38.59%依 MSCI World 權重；前10大持股 NVDA2.31+AAPL2.14+AVGO1.21+MSFT1.21+GOOGL1.06=7.9%",
    },
    "摩根JPM多重收益": {
        "資訊科技": 0.1665, "金融": 0.0865, "工業": 0.058, "醫療保健": 0.0489, "非核心消費": 0.0453, "通訊服務": 0.0452, "核心消費": 0.0255, "能源": 0.0216, "原物料": 0.0173, "公用事業": 0.0124, "不動產": 0.0083, "其他": 0.0, "固收/現金": 0.4645,
        "_src": "L3 官方資產類別2026/07/31（MoneyDJ jfzn3）：環球股票28.6/美非投等債28.0/美股票掩護性買權9.5/歐洲股票6.7/現金5.9/特別股4.5/EM債4.5/EM股4.4/非機構證券4.4/歐非投等債2.3/全球投等信貸1.0/短天期0.2 → 股權53.7%依 MSCI World 產業權重（iShares URTH 2026/9/21）；固收/現金46.45%",
    },
    "M&G入息": {
        "金融": 0.1, "資訊科技": 0.0807, "工業": 0.058, "非核心消費": 0.0481, "通訊服務": 0.0238, "醫療保健": 0.0269, "核心消費": 0.014, "能源": 0.0119, "公用事業": 0.0068, "不動產": 0.0045, "其他": 0.0, "固收/現金": 0.6253,
        "_src": "L1+L3 晨星2026/6 股39.25/債57.89/現4.64（8/23截圖真值；MoneyDJ 2026/07/31 有效部位為股47.6/債45.5/現6.9，含期貨，故沿用晨星口徑）；已知 5 行業＝晨星；未揭露權益尾依 MSCI World 相對權重補（醫療2.69/核心消費1.40/能源1.19/公用0.68/不動產0.45）",
    },
    "PIMCO收益增長": {
        "資訊科技": 0.325, "金融": 0.148, "工業": 0.115, "醫療保健": 0.107, "非核心消費": 0.091, "通訊服務": 0.052, "能源": 0.049, "核心消費": 0.042, "原物料": 0.036, "公用事業": 0.023, "其他": 0.012,
        "_src": "L1 官方月報2026/03/31（MoneyDJ pima1）：資訊科技32.5/金融14.8/工業11.5/醫療護理10.7/非必需消費9.1/通訊5.2/能源4.9/必需消費4.2/原物料3.6/公用2.3",
    },
    "安聯收益成長": {
        "資訊科技": 0.242, "工業": 0.1126, "金融": 0.1038, "通訊服務": 0.1028, "非核心消費": 0.0914, "醫療保健": 0.0804, "固收/現金": 0.0669, "能源": 0.0493, "公用事業": 0.0398, "不動產": 0.0397, "原物料": 0.0342, "核心消費": 0.0239, "其他": 0.0132,
        "_src": "L1 官方月報2026/07/31 完整產業表（MoneyDJ tlz64）：資訊科技24.2/工業11.26/金融10.38/通訊服務10.28/非必需消費9.14/健康護理8.04/流動資金6.69/能源4.93/公用3.98/房地產3.97/原物料3.42/必需消費2.39/其他1.31",
    },
...
def calc_industry_penetration(snap: dict) -> dict:
    ...
    return {
        ...
        "備註": (f"L1=公開月報權重 L2=公開成分權重 L3=指數基準 L4=名稱/類型推估。"
                 f"2026-09-23 兩階段細化：第一階段 ETF 15 檔改 L2、貝萊德 B11 改 L3、L1/別名補齊；"
                 f"第二階段拆解六檔基金「其他」——安聯收益成長/PIMCO 用官方完整產業表，摩根/聯博/富達/M&G 用官方資產類別＋MSCI World 補權，"
                 f"元大卓越50連結＝0050 權重。未分類 34.6%→{pct['未分類(其他權重)']:.1f}%（動態）。"
                 f"剩餘為富達另類資產（黃金/商品）、小型境內基金（路博邁5G/台中銀優息/台新半導體/國泰高股息）與 ETF 指數「其他」桶。"
                 f"⚠️ 本表「固收/現金」為 GICS 研究殘餘桶，非防守比例（防守看五桶穿透合併口徑）"),
    }
