...
def calc_industry_penetration(snap: dict) -> dict:
    ...
    return {
        ...
        "備註": ("L1=公開月報權重 L2=公開成分權重 L3=指數基準 L4=名稱/類型推估。"
                 "2026-09-23 兩階段細化：第一階段 ETF 15 檔改 L2、貝萊德 B11 改 L3、L1/別名補齊；"
                 "第二階段拆解六檔基金「其他」——安聯收益成長/PIMCO 用官方完整產業表，摩根/聯博/富達/M&G 用官方資產類別＋MSCI World 補權，"
                 "元大卓越50連結＝0050 權重。未分類 34.6%→1.7%。剩餘為小型境內基金（路博邁5G/台中銀優息/台新半導體/國泰高股息）與 ETF指數「其他」桶"),
    }
