...
STALE = [
    ...
    # 2026-09-26：移除 "102,469" — 8 月保單配息校正後真值即 102,469（安聯 76,931＋第一金 25,538），
    #   已成為 investment_performance_adjust.json 歷史表與 work_log 的合法顯示值；當月卡（div_ins）
    #   的舊值風險改由 build_dashboard rep + check_dashboard_sync 的 data-k 比對守門。
