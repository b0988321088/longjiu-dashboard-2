#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""notion_weekly.py — Notion 週報單一入口（整合 2 支：notion_ai_weekly_wrapper/notion_weekly_trend_wrapper）。

  ai      AI 週報
  trend   趨勢週報
  all     兩者依序執行（預設，週五 10:00）"""
import argparse
import os
import subprocess
import sys
...
DEFAULT_MODE = 'all'
MODES = {'ai': [('notion_ai_weekly_wrapper.py', (), False)], 'trend': [('notion_weekly_trend_wrapper.py', (), False)], 'all': [('notion_ai_weekly_wrapper.py', (), False), ('notion_weekly_trend_wrapper.py', (), False)]}
