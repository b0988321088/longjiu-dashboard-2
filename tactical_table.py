...
STRATEGY = {
    ...
    "債券": {
        "action": "維持", "ticker": "PIMCO/M&G/00983D",
        "note": "2026-08-24 裁示不做債梯：保單轉換 PIMCO M級120萬+M&G 115萬涵蓋債券需求；00983D底倉維持",
        "stop": "US30Y≥5.30%凍結新增；不做美元直債梯",
...
def build_table(snap: dict, us30y: float = None) -> dict:
    ...
    # 目標區間：目標 ±5pp（可調整）
    target_map = {
        "台股市值型成長": ("台股市值型", "台股市值型成長"),
        "美股市值型成長": ("美股市值型", "美股市值型成長"),
        "防守型配息": ("防守型配息", "防守型配息"),
        "債券": ("債券", "債券"),
        "現金/安全網": ("現金", "現金/安全網"),
    }
