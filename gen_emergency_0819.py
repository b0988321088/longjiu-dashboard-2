# -*- coding: utf-8 -*-
"""台股緊急應變 2026-08-19 — 從 data/emergency_llm_analysis.json 渲染完整 HTML（Railway + GitHub 版）

資料源：LLM 完整分析（六大章節）→ JSON → 本腳本產出 emergency_report_2026-08-19.html
+ emergency_taiex_report_2026-08-19.html（同內容，命名供 Railway / GitHub Pages 使用）
"""
import json, re
...
# INC-134 補強（2026-08-19）：動態注入穿透五桶 + 總資產（緊急應變必須含穿透真值）
try:
