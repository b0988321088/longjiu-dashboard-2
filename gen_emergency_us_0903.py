# -*- coding: utf-8 -*-
"""美股緊急應變 9/3 21:30 — 從 data/emergency_llm_analysis.json 渲染兩版 HTML
...
def build():
    ...
    kpis = [
        ("道瓊 (DJI)", "53,422.83", "+0.68%", "up"), ("S&P 500", "7,702.23", "+0.46%", "up"),
        ("納斯達克 (IXIC)", "26,371.35", "+0.59%", "up"), ("費城半導體 (SOX)", "11,104.09", "-2.07%", "down"),
        ("台積電 ADR (TSM)", "408.70", "-1.64%", "down"), ("NVIDIA (NVDA)", "226.60", "+0.98%", "up"),
        ("Meta (META)", "617.07", "+4.08%", "up"), ("Microsoft (MSFT)", "507.91", "+2.23%", "up"),
        ("US30Y", "5.27%", "警戒5.30", "warn"), ("台股加權 (TWII)", "45,857.66", "-0.67%", "down"),
    ]
