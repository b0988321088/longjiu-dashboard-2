...
def build_trade_plan(rec: dict, snap: dict) -> list:
    ...
    tickers = {"非核心消費": "0050(含)、0051(中型100-消費涵蓋,回檔-5%再進)", "醫療保健": "保單健康科學A2（8/24 轉換 50萬涵蓋）", "高股息防禦": "00878、00713、0056",
               "金融": "0055(金融)"}
    reasons = {
        "非核心消費": "景氣敏感消費(旅遊/餐飲/汽車)低基期+資金流入；0051 現 142 近 52 週高點(152)，等回檔 -5% 再分批；資金等 8/31 贖回回流/9 月配息",
        "醫療保健": "醫療穿透 1.4% vs 目標 8% 低配；台股無純醫療ETF（00970B 實為美元公司債、00786 查無），由 8/24 保單轉換健康科學A2 補足，配額轉現金保留",
