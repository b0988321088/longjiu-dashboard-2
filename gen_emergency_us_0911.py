...
chapters = {
    "一、市場概況": "8月CPI 總 3.4%/核心 2.4%（符合預期、核心降溫）；美股盤中 S&P 7,672.34（+1.06%）、納指 26,412.70（+1.27%）、費半 11,880.66（+2.29%）；VIX 15.80（-11.43%）；US30Y 5.32%、US10Y 4.93%；WTI 99.14（-3.26%）、黃金 4,412.30（+1.10%）；USD/TWD 31.60。",
